...
#  de Renda. No exemplo fornecido (abaixo), a taxa é de 8% sobre R$ 1000.00 + 18% sobre R$ 2.00, o que resulta em R$ 80.36 no total. O valor deve ser impresso com duas
# casas decimais.
...
brute_salary = float(input())
total_taxes = 0

if brute_salary >= 0.00 and brute_salary <= 2000.00:
  print("Isento")
elif brute_salary >= 2000.01 and brute_salary <= 3000.00:
  total_taxes = (brute_salary - 2000.00) * 0.08
  print(f"R$ {total_taxes:.2f}")
elif brute_salary >= 3000.01 and brute_salary <= 4500.00:
  total_taxes = 1000.00 * 0.08 + (brute_salary - 3000.00) * 0.18
  print(f"R$ {total_taxes:.2f}")
else:
  total_taxes = 1000.00 * 0.08 + 1500.00 * 0.18 + (brute_salary - 4500.00) * 0.28
  print(f"R$ {total_taxes:.2f}")
